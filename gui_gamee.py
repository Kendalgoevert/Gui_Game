...
'''this is a game library that has a user interface'''
...
'''Sub-frame containing all the checkboxes with the different search paramiters'''
...
'''contains all of the diferent searchparaniters and an entry box to search for a game'''
